...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($errors)) {
        ...
        if ($con) {
            ...
            $sql = "INSERT INTO taikhoan (username, email, sodienthoai, password) VALUES ('$username', '$email', '$sodienthoai', '$password_hashed')";
                        ...
                        <div class="col-lg-5">
                            <div class="card shadow-lg border-0 rounded-lg mt-5">
                                <div class="card-header">
                                    <h3 class="text-center font-weight-light my-4">ĐĂNG KÝ || ADMIN</h3>
                                </div>
                                <div class="card-body">
                                    <?php
                                    if (!empty($errors)) {
                                    ...
                                    <form method="post" action="signup.php">
                                        ...
                                        <div class="text-center mt-3">
                                            <span>Bạn đã có tài khoản? </span>
                                                <a href="login.php" class="small">Đăng nhập ngay!</a>
                                            </div>
                                    </form>
                                </div>
                            </div>
